...
선택 정렬은 리스트에서 가장 작은 값을 찾아서 맨 앞에 가져다 놓는 방식입니다. $$i$$가 $$[0, \text{len})$$ 일 때, $$j$$$$i$$의 뒤에서 가장 큰 값을 찾아서 $$i$$번째 수와 교환하는 방식입니다. 시간복잡도는 $$O(n^2)$$ 이 됩니다.
