...
1. $$a, b \in \mathbb{N}, \, a \geq b > 0$$인 $$a, b$$에 대해 $$a = bq + r$$로 표현할 수 있다.
2. $$r = a - bq$$ 이다.
3. $$d \, | \, a, d \, | \, b$$인 정수 $$d$$에 대해서 $$d \,|\, bq$$ 이므로 $$d \,|\, a - bq$$이다.
4. 따라서 $$d \,|\, r$$ 이다. 즉, $$d$$가 $$a, b$$의 공약수라면 $$b, r$$의 공약수이기도 하다.
5. 마찬가지로 $$d$$가 $$b, r$$의 공약수라면 $$a, b$$의 공약수이다.
6. 즉, $$a, b$$와 $$b, r$$의 공약수들의 집합이 서로 같다.
